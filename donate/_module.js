...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-myzmg3', document.head);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div4, "id", "section-65aaab85-dcdd-4b32-b294-b416b609ea7a");
		},
		m(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "id", "section-1f2f5494-d882-44c9-868f-b5a8728f2d27");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "id", "section-190289d8-2eb9-401f-b56f-36e94faf7167");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div0, "class", "component");
			attr(div1, "class", "section");
			attr(div1, "id", "section-e00bd588-3983-4cb3-9b02-5cffad473fcd");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
			...
			props: {
				...
				testimonials: [
					...
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/kEreKKy.jpg",
							"url": "https://i.imgur.com/kEreKKy.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/UVt8T3J.jpg",
							"url": "https://i.imgur.com/UVt8T3J.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/4CxrBEr.jpg",
							"url": "https://i.imgur.com/4CxrBEr.jpg",
							"size": null
						}
					}
				]
				...
				items: [
					{
						...
						"lists": [
							{
								"ls": "$50 provides 12 hours of professional interpretation for clients in our legal aid programs"
							},
							{
								"ls": "$100 provides a healthy lunch for 220 school children"
							},
							{
								"ls": "$500 provides two months of psychosocial support to refugee communities through one of our caseworkers."
							}
						],
						"header": [],
						"texter": [
							{
								"pos": "A modest donation can go a long way towards building and sustaining StARS services:"
							}
						]
					},
					{
						...
						"lists": [
							{ "ls": "By check" },
							{ "ls": "By credit or debit card" },
							{
								"ls": "By automatic monthly bank withdrawal"
							},
							{ "ls": "Via PayPal" }
						],
						"header": [],
						"texter": [
							{
								"pos": "Please consider how much you can spare to help our students and clients. You can donate in person, or make tax-deductible gifts:"
							}
						]
					}
				]
