...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "id", "section-ad6be4ce-a5e4-427c-9781-ec752b5ca44f");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div3, "id", "section-6acb4fa5-66a5-4496-9e8b-d8f090fe5512");
		},
		m(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	return [content, dow, imeg, link, items];
}
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "class", "section");
			attr(div1, "id", "section-aa493fff-94b8-484f-97f7-91bdd082e216");
		},
		m(target, anchor) {
...
function create_fragment$5(ctx) {
			...
			props: {
				...
				testimonials: [
					...
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/6jI5xHA.jpg",
							"url": "https://i.imgur.com/6jI5xHA.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/vY9KDAg.jpg",
							"url": "https://i.imgur.com/vY9KDAg.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/zzMWlhl.jpg",
							"url": "https://i.imgur.com/zzMWlhl.jpg",
							"size": null
						}
					}
				]
	...
	component_3 = new Component$3({
			props: {
				...
				content: {
					"html": "<p>Address: 38 July 26 Street, Downtown, Cairo</p><p>For more information, please email <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link\" href=\"mailto:info@stars-egypt.org\">info@stars-egypt.org</a></p><p>Our Metro Stop: Nasser Metro (one stop north of Sadat)</p>",
					"markdown": "Address: 38 July 26 Street, Downtown, Cairo\n\nFor more information, please email [info@stars-egypt.org](<mailto:info@stars-egypt.org>)\n\nOur Metro Stop: Nasser Metro (one stop north of Sadat)\n\n"
				}
			}
		});
