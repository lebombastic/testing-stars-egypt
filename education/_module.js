...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-1mt7zmj', document.head);
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div4, "id", "section-a3d05d67-14b3-4c2b-9699-6df3a3d1beee");
		},
		m(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div2, "id", "section-a9bf7add-d388-4d20-a18d-edecd228a3c9");
		},
		m(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "id", "section-6ef80cc7-34c3-40b6-bc3d-18f0ced408df");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
...
function create_fragment$4(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div0, "class", "component");
			attr(div1, "class", "section");
			attr(div1, "id", "section-50fb38ba-045a-4217-8684-669eb0a6f5b7");
		},
		m(target, anchor) {
			insert_hydration(target, div1, anchor);
			append_hydration(div1, div0);
				...
				testimonials: [
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/z5gblox.jpg",
							"url": "https://i.imgur.com/z5gblox.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/lTWx4Ut.jpg",
							"url": "https://i.imgur.com/lTWx4Ut.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/RBaRGGL.jpg",
							"url": "https://i.imgur.com/RBaRGGL.jpg",
							"size": null
						}
					},
					{
						"images": {
							"alt": "",
							"src": "https://i.imgur.com/WQc16kY.jpg",
							"url": "https://i.imgur.com/WQc16kY.jpg",
							"size": null
						}
					}
				]
				...
				items: [
					{
						"items": [],
						"lists": [
							{ "ls": "The Montessori Preschool Program" },
							{ "ls": "The Children’s Education Program" },
							{ "ls": "The Adult Education Program" },
							{ "ls": "The Capacity Building Program" }
						],
						"header": [{ "heading": "Education Services" }],
						"texter": [
							{
								"pos": "StARS Education Department provides comprehensive education services to displaced people and other vulnerable migrants in Cairo through four programs:"
							}
						]
					},
					{
						"items": [{ "subhed": "Montessori Preschool" }],
						"lists": [],
						"header": [],
						"texter": [
							{
								"pos": "StARS Montessori Preschool provides education and care for children aged 3-6 based on the Montessori pedagogical approach for early childhood development. Our refined approach to child-centered learning paves the way for enrollment into our Children’s Education Program. Our parent engagement component also provides advice and guidance on childhood development at home."
							}
						]
					},
					{
						"items": [{ "subhed": "Children’s Education Program" }],
						"lists": [],
						"header": [],
						"texter": [
							{
								"pos": "The Children’s Education Program teaches the Sudanese English curriculum to children aged 6-19 through grades 1–12 with the opportunity to gain a 9th and 12th grade certificate. CEP students come from many different countries, including Sudan, South Sudan, Eritrea, Ethiopia, Somalia, Yemen, and Uganda. Students also benefit from our School Meal Program, providing a nutritious breakfast and lunch."
							}
						]
					},
					{
						"items": [{ "subhed": "Adult Education Program" }],
						"lists": [
							{
								"ls": "English language: We offer 8 levels of English based on the four skills of reading, writing, listening, and speaking. English language students are also given the opportunity to attend weekly tutoring sessions with fluent or native English speakers living in Cairo."
							},
							{
								"ls": "Arabic literacy: This course is designed for Arabic and non-Arabic speakers who want to learn how to speak, read and write in Arabic."
							},
							{
								"ls": "IT Classes: IT classes include basic computer skills such as Word, PowerPoint, and Excel."
							},
							{
								"ls": "Handicrafts and accessories: The Handicrafts class teaches female students how to use simple materials to create accessories and home decorations to sell."
							},
							{
								"ls": "Basic Sewing: This course is designed for female beginners, as well as those with little experience who are looking for opportunities to practice their sewing skills."
							},
							{
								"ls": "Henna Classes: This course teaches female students the art of designing and painting patterns on parts of the body."
							},
							{
								"ls": "Hairstyling Classes: Female students are taught every aspect of hairstyling from the very basics to bridal hairstyling."
							}
						],
						"header": [],
						"texter": [
							{
								"pos": "The Adult Education Program is open to all displaced people and vulnerable migrants in Cairo. Our teachers are from the displaced communities in Egypt and are assisted by international volunteers. We aim to offer a wide variety of classes that impart practical skills, including:"
							}
						]
					},
					{
						"items": [
							{
								"subhed": "Education Access and Capacity Building Program"
							}
						],
						"lists": [
							{
								"ls": "Community School Capacity Building: The program provides tailored teacher training and school management workshop sessions to strengthen technical skills within refugee community schools in Cairo."
							},
							{
								"ls": "Professional Development Courses: We partner with the Centre for Migration and Refugee Studies at the American University of Cairo (AUC) to create free, high-quality, professional development courses. Courses include academic discussion, public speaking, policy and advocacy, Teaching English as a Foreign Language, and introduction to public relations."
							},
							{
								"ls": "Pathways Workshops: Pathways Workshops provide StARS graduates with information on how to access further educational and employment opportunities in Cairo. "
							},
							{
								"ls": "Entrepreneurship and Livelihood for Unaccompanied Youth: Supporting aged out unaccompanied youth via technical/vocational training, business management training, and provision of micro-grants in establishing small businesses. The support also includes referrals to other available TVET opportunities in Cairo."
							}
						],
						"header": [],
						"texter": []
